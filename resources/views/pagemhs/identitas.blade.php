      ...
      <div class="card-body">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/Identitas">Identitas Pribadi</a></li>
                <li class="breadcrumb-item active" aria-current="page">Identitas</li>
            </ol>
        </nav>
        <div class="alert alert-danger" role="alert">
            <strong>Semua data wajib terisi untuk melanjutkan proses selanjutnya.</strong>
        </div>
        {{--
        <p>Nomor Pendaftaran: {{ $pendaftaran->nomor_registrasi }}</p>
        <p>Jalur Masuk/Kelas: {{ $pendaftaran->jalurmasuk->nm_jalur }}</p>
        <p>Nama Lengkap: {{ $pendaftaran->user->name }}</p>
    
        <h2>Detail Identitas</h2>
        @if($pendaftaran->identitasDetail)
            <p>NIK: {{ $pendaftaran->identitasDetail->NIK }}</p>
            <p>NISN: {{ $pendaftaran->identitasDetail->NISN }}</p>
            <p>Asal Sekolah: {{ $pendaftaran->identitasDetail->asalsekolah }}</p>
            <p>Tempat Lahir: {{ $pendaftaran->identitasDetail->tempatlahir }}</p>
            <p>Tanggal Lahir: {{ $pendaftaran->identitasDetail->tanggallahir }}</p>
            <!-- Tampilkan upload file sesuai format -->
        @else
            <p>Detail identitas tidak ditemukan.</p>
        @endif --}}
...
<section class="py-3 py-md-5 py-xl-8">
      <div class="row gy-4 gy-lg-0">
        <div class="col-12 col-lg-4 col-xl-3">
          <div class="row gy-4">
            <div class="col-12">
                <div class="card-header text-bg-primary">Welcome, {{ $pendaftaran->user->name }}</div>
                <div class="card-body">
                  <div class="text-center mb-3">
                    @if ($pendaftaran->identitasDetail && $pendaftaran->identitasDetail->foto)
                        <img src="{{ asset('storage/' . $pendaftaran->identitasDetail->foto) }}" class="img-fluid rounded-circle" alt="Luna John">  
                    @else
                        <img src="{{asset('inisma/avatar.png')}}" class="img-fluid rounded-circle" alt="Luna John">
                    @endif
                  </div>
                  <h5 class="text-center mb-1">{{ $pendaftaran->user->name }}</h5>
                  <p class="text-center text-secondary mb-6">Calon Mahasiswa Baru</p>
                  {{-- <ul class="list-group list-group-flush mb-6">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <h6 class="m-0 text-center">{{ $pendaftaran->nomor_registrasi }}</h6>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <h6 class="m-0 text-center">{{ $pendaftaran->jalurmasuk->nm_jalur }}</h6>
                    </li>
                  </ul> --}}
                  <p class="text-center text-secondary mb-6">{{ $pendaftaran->jalurmasuk->nm_jalur }}</p>
                  {{-- <h6 class="m-0 text-center">{{ $pendaftaran->jalurmasuk->nm_jalur }}</h6> --}}
                  <div class="d-grid m-0">
                    <button class="btn btn-outline-primary" type="button">Ubah Foto</button>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div class="p-4">
              <ul class="nav nav-tabs" id="profileTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link active" id="overview-tab" data-bs-toggle="tab" data-bs-target="#overview-tab-pane" type="button" role="tab" aria-controls="overview-tab-pane" aria-selected="true">Data Detail</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="password-tab" data-bs-toggle="tab" data-bs-target="#password-tab-pane" type="button" role="tab" aria-controls="password-tab-pane" aria-selected="false">Ubah Password</button>
                </li>
              </ul>
                ...
                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabindex="0">
                  ...
                  <table class="table table-borderless table-bordered mb-0">
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $pendaftaran->nomor_registrasi }}</td>
                    </tr>
                    <tr>
                        <td>Nama Lengkap</td>
                        <td>:</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $pendaftaran->jalurmasuk->nm_jalur }}</td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>program Studi</td>
                        <td>:</td>
                        <td>{{ $pendaftaran->prodiyangdipilih }}</td>
                    </tr>
                  </table>
                  {{-- <div class="row g-0">
