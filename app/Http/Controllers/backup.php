...
class PendaftaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Log::info('Tanggal lahir:', ['tanggal' => $tanggalLahir]);
        Log::info('Total count:', ['count' => $totalCount]);
        ...
        //Buat Oreder dan SNAP Token Midtrans
    ...
    private function createOrder($user, $request, $pendaftaran)
    {
        ...
        // $expiryDurationInSeconds = 7 * 24 * 60 * 60;
        ...
        $transactionDetails = [
            ...
            'expiry' => [
                'start_time' => now()->toIso8601String(), // Waktu mulai transaksi, menggunakan waktu sekarang
                // 'duration' => 60, // Durasi dalam detik, misalnya 1 jam (3600 detik)
                'duration' => $expiryDurationInSeconds,
            ]
        ];
        ...
        Order::create([
            ...
            'expires_at' => now()->addSeconds($expiryDurationInSeconds), // Waktu kadaluarsa di database (1 minggu)
        ]);
    }
}
